...
public class HumFragment extends BaseFragment {
    ...
    private TextView txtCurrentHum;
    private LinearLayout llEverydayHumRecordContainer;
    private LineChart lineChartTodayHum;
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        txtCurrentHum = (TextView) view.findViewById(R.id.txt_current_hum_info);
        llEverydayHumRecordContainer = (LinearLayout) view.findViewById(R.id.ll_everyday_hum_container);
        lineChartTodayHum = (LineChart) view.findViewById(R.id.line_chart_today_hum);
    }
    ...
    private void initData(){
        ...
        if (mActivity.subDevice != null) {
            txtCurrentHum.setText(TextUtils.isEmpty(mActivity.subDevice.getHumidity()) ? 0 + "" : mActivity.subDevice.getHumidity());
            //当子设备不是空的时候获取设备温湿度记录
        }
        for (int i = 30; i > 0; i--) {
        ...
        for (int i = 0; i < dataDeviceList.size(); i++) {
            ...
            View view = LayoutInflater.from(mActivity).inflate(R.layout.temphum_item_temp_hum, llEverydayHumRecordContainer,false);
            ...
            txtData.setText(dataDevice.getHumidity());

            llEverydayHumRecordContainer.addView(view);
        }
        ...
        hashMap.put(hours + "", (int) (Math.random() * 100));
        keyList.add(hours + "");
        ...
        keyList.add("现在");
        hashMap.put("现在", (int) (Math.random() * 100));
        lineChartTodayHum.setMinValue(0);
        lineChartTodayHum.setData(hashMap, keyList);
    }
