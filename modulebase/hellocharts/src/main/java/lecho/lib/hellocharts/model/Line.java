...
public class Line {
    ...
    public Line(Line line) {
        ...
        if (line.getShaderColors() != null) {
            this.shaderColors = new int[line.getShaderColors().length];
            for (int i = 0; i < line.getShaderColors().length; i++) {
                this.shaderColors[i] = line.getShaderColors()[i];
            }
        }
    }
