...
package com.heiman.widget.miui;
...
public class NumberPicker extends LinearLayout {
    ...
    public NumberPicker(Context context, AttributeSet attrs, int defStyle) {
        ...
        mLabelPaint.setColor(getResources().getColor(R.color.class_text_14));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int selectorIndex : selectorIndices) {
            ...
            if (posy < 1) {
                mSelectorWheelPaint.setColor(getAlphaGradient(posy, getResources().getColor(R.color.class_text_14)/*TEXT_COLOR_FG*/, true));
                canvas.drawText(scrollSelectorValue, x, y + (sizeFg - TEXT_SIZE_MIN) / 2.0f, mSelectorWheelPaint);
            }
