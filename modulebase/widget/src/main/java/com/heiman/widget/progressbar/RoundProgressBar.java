package com.heiman.widget.progressbar;
...
public class RoundProgressBar extends View {
    ...
    private int roundBackgroundColor; //圆形的背景颜色，考虑到可能需要设置圆内的颜色
    ...
    public RoundProgressBar(Context context, AttributeSet attrs, int defStyle) {
        ...
        roundBackgroundColor = mTypedArray.getColor(R.styleable.RoundProgressBar_roundBackgroundColor, Color.TRANSPARENT);
