package com.heiman.widget.helper;
...
public class GridDividerItemDecortion extends RecyclerView.ItemDecoration {
    private Paint mPaint;
    private int mDividerWidth;

    public GridDividerItemDecortion(int height, @ColorInt int color) {
