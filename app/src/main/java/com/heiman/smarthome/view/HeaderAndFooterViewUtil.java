...
public class HeaderAndFooterViewUtil {
    ...
    public static View getHeadView(Context context, boolean isVertical, int bgColor, String text) {
        ...
        if (isVertical) {
            headviewContentParams = new FrameLayout.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, dip2px(context, 50));
        } else {
            headviewContentParams = new FrameLayout.LayoutParams(dip2px(context, 50), ViewGroup.LayoutParams.WRAP_CONTENT);
        }
        headviewContentParams.gravity = Gravity.CENTER_VERTICAL;
        headviewContent.setLayoutParams(headviewContentParams);
        headviewContent.setGravity(Gravity.CENTER_VERTICAL);
        headviewContent.setPadding(dip2px(context, 12), 0, 0, 0);
//        headviewContent.setTextSize(dip2px(context, (float) 9.6));
    ...
    public static View getFooterView(Context context, boolean isVertical, int bgColor, String text) {
        ...
        if (isVertical) {
            footerviewContent1Params = new FrameLayout.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, dip2px(context, 50));
        } else {
            footerviewContent1Params = new FrameLayout.LayoutParams(dip2px(context, 50), ViewGroup.LayoutParams.WRAP_CONTENT);
        }
