...
public class LaunchConditionActivity extends BaseActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentLayout(R.layout.activity_launch_condition);
    ...
    public void onClick(View v) {
        ...
        if (!UsefullUtill.judgeClick(R.layout.activity_launch_condition, 500)) {
