...
import com.heiman.smarthome.widget.styleabletoastlibrary.StyleableToast;
...
public class XlinkUtils {
    ...
    public static boolean isWifi() {
        ConnectivityManager cm = (ConnectivityManager) MyApplication.getMyApplication()
    ...
    public static void shortTips(String tip, int bgcolor, int tvcolor, int drawable, boolean isspin) {
        ...
        StyleableToast st = new StyleableToast(MyApplication.getMyApplication(), tip, Toast.LENGTH_SHORT);
    ...
    public static void longTips(String tip) {
        StyleableToast st = new StyleableToast(MyApplication.getMyApplication(), tip, Toast.LENGTH_LONG);
    }
